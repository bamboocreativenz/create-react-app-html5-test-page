    ...
                <footer><p><a href="#top">[Top]</a></p></footer>
      ...
      p q r s t u v w x y z {'{ | }'} ~ </pre>
          ...
          <footer role="contentinfo">
            <p>Made by <a href="http://twitter.com/forge_tools">@forge_tools</a>.Code on <a href="https://github.com/enspiral-pods/create-react-app-html5-test-page">Github</a> Inspired by <a href="http://github.com/cbracco/html5-test-page">cbracco's html5-test-page</a>.</p>
          </footer>
        </div>
      </div>
    );
